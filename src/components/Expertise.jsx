        ...
        >
          <div className="flex text-white justify-center">
            ...
            <div className="w-2/3 text-center space-y-4">
              ...
              <p>
              I specialize in a diverse range of technologies, ensuring robust backend systems and engaging frontend experiences. Here’s an overview of my core skills:
              </p>
